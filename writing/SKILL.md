...
For comprehensive research on why these patterns occur, see `references/00-ai-writing-patterns.md`. Wikipedia editors developed this guide to detect AI-generated submissions — their patterns are well-documented and field-tested.
