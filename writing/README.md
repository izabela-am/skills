...
- **Most tasks need only one file**: `references/03-elementary-principles-of-composition.md`
...
|---------|------|--------|---------|
| Grammar & punctuation | `references/02-elementary-rules-of-usage.md` | ~2,500 | Comma rules, possessives, sentence structure |
| Composition principles | `references/03-elementary-principles-of-composition.md` | ~4,500 | Active voice, concision, paragraph structure |
| Formatting | `references/04-a-few-matters-of-form.md` | ~1,000 | Headings, quotations, formatting conventions |
| Word choice | `references/05-words-and-expressions-commonly-misused.md` | ~4,000 | Common errors, word selection |
| AI patterns | `references/00-ai-writing-patterns.md` | ~25,000 | Wikipedia editors' field guide to AI detection |
...
6. **Load reference files sparingly** - Most tasks need only `references/03-elementary-principles-of-composition.md`
...
writing/
  ...
  README.md                # This file
  references/
    00-ai-writing-patterns.md   # AI pattern detection guide
    01-introductory.md
...
**Claude Code:**
```bash
cp -r writing ~/.claude/skills/writing-clearly-and-concisely
```
